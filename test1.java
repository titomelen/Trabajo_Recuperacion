...
class test1 {
	...
	@Test
	void test1funcion1() {
		assertEquals(true, totalfunciones.funcion1("erase una vez un betico que vio ganar al betis la champi"));
	}

	@DisplayName(value = "Prueba de caja negra de limite inferior -1")
	@Test
	void test2funcion1() {
		assertEquals(false, totalfunciones.funcion1("Javier Melendez Contreras"));
	}
	...
	void test4funcion1() {
		assertEquals(true, totalfunciones.funcion1("erase una vez un betico que vio ganar al betis la champions y no quiso despertar nunca"));
	}
	...
	void test7funcion1() {
		assertEquals(true, totalfunciones.funcion1("esta cuarentena se esta haciendo demasiado larga ya, alguien deberia ir al futuro a por la cura para acelerar el proceso."));
	}
